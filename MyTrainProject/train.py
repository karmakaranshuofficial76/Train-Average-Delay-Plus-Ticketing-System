#MADE BY: ANSHU KARMAKAR Contact emailid:karmakaranshu76@gmail.com Mobile:8639548225,9949601220
...
class tickets:
    ...
    def cancellation(self):
        ...
        print(r= int(input("ENTER PNR NUMBER : ")))
        try:
            while(True):
                tick=load(fin)
                z=tick.ret()
